var OnigurumaToES=(()=>{var ne=Object.defineProperty;var wt=Object.getOwnPropertyDescriptor;var At=Object.getOwnPropertyNames;var St=Object.prototype.hasOwnProperty;var _t=(e,t)=>{for(var r in t)ne(e,r,{get:t[r],enumerable:!0})},kt=(e,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let n of At(t))!St.call(e,n)&&n!==r&&ne(e,n,{get:()=>t[n],enumerable:!(s=wt(t,n))||s.enumerable});return e};var xt=e=>kt(ne({},"__esModule",{value:!0}),e);var Rr={};_t(Rr,{compile:()=>ke,toOnigurumaAst:()=>Et,toRegExp:()=>vr,toRegexAst:()=>Lr});var se=String.raw,be=se`(?:\p{Emoji}\uFE0F\u20E3?|\p{Emoji_Modifier_Base}\p{Emoji_Modifier}?|\p{Emoji_Presentation})`,ye=se`\u{E0061}-\u{E007A}`,Ne=()=>new RegExp(se`[\u{1F1E6}-\u{1F1FF}]{2}|\u{1F3F4}[${ye}]{2}[\u{E0030}-\u{E0039}${ye}]{1,3}\u{E007F}|${be}(?:\u200D${be})*`,"gu");var A=String.fromCodePoint,f=String.raw,q={ES2018:2018,ES2024:2024,ESNext:2025};function L(e,t,r){return e.has(t)||e.set(t,r),e.get(t)}function j(e,t){return q[e]>=q[t]}function y(e,t){if(!e)throw new Error(t??"Value expected");return e}var bt=new Set([A(304),A(305)]);function oe(e){if(bt.has(e))return[e];let t=new Set,r=e.toLowerCase(),s=r.toUpperCase(),n=$t.get(r),o=Nt.get(r);return[...s].length===1&&t.add(s),t.add(r),n&&t.add(n),o&&t.add(o),[...t]}var ie=new Set(["C","Other","Cc","Control","cntrl","Cf","Format","Cn","Unassigned","Co","Private_Use","Cs","Surrogate","L","Letter","LC","Cased_Letter","Ll","Lowercase_Letter","Lm","Modifier_Letter","Lo","Other_Letter","Lt","Titlecase_Letter","Lu","Uppercase_Letter","M","Mark","Combining_Mark","Mc","Spacing_Mark","Me","Enclosing_Mark","Mn","Nonspacing_Mark","N","Number","Nd","Decimal_Number","digit","Nl","Letter_Number","No","Other_Number","P","Punctuation","punct","Pc","Connector_Punctuation","Pd","Dash_Punctuation","Pe","Close_Punctuation","Pf","Final_Punctuation","Pi","Initial_Punctuation","Po","Other_Punctuation","Ps","Open_Punctuation","S","Symbol","Sc","Currency_Symbol","Sk","Modifier_Symbol","Sm","Math_Symbol","So","Other_Symbol","Z","Separator","Zl","Line_Separator","Zp","Paragraph_Separator","Zs","Space_Separator","ASCII","ASCII_Hex_Digit","AHex","Alphabetic","Alpha","Any","Assigned","Bidi_Control","Bidi_C","Bidi_Mirrored","Bidi_M","Case_Ignorable","CI","Cased","Changes_When_Casefolded","CWCF","Changes_When_Casemapped","CWCM","Changes_When_Lowercased","CWL","Changes_When_NFKC_Casefolded","CWKCF","Changes_When_Titlecased","CWT","Changes_When_Uppercased","CWU","Dash","Default_Ignorable_Code_Point","DI","Deprecated","Dep","Diacritic","Dia","Emoji","Emoji_Component","EComp","Emoji_Modifier","EMod","Emoji_Modifier_Base","EBase","Emoji_Presentation","EPres","Extended_Pictographic","ExtPict","Extender","Ext","Grapheme_Base","Gr_Base","Grapheme_Extend","Gr_Ext","Hex_Digit","Hex","IDS_Binary_Operator","IDSB","IDS_Trinary_Operator","IDST","ID_Continue","IDC","ID_Start","IDS","Ideographic","Ideo","Join_Control","Join_C","Logical_Order_Exception","LOE","Lowercase","Lower","Math","Noncharacter_Code_Point","NChar","Pattern_Syntax","Pat_Syn","Pattern_White_Space","Pat_WS","Quotation_Mark","QMark","Radical","Regional_Indicator","RI","Sentence_Terminal","STerm","Soft_Dotted","SD","Terminal_Punctuation","Term","Unified_Ideograph","UIdeo","Uppercase","Upper","Variation_Selector","VS","White_Space","space","XID_Continue","XIDC","XID_Start","XIDS"]),ce=new Map;for(let e of ie)ce.set(K(e),e);var yt=new Set(["Basic_Emoji","Emoji_Keycap_Sequence","RGI_Emoji","RGI_Emoji_Flag_Sequence","RGI_Emoji_Modifier_Sequence","RGI_Emoji_Tag_Sequence","RGI_Emoji_ZWJ_Sequence"]),ue=new Map;for(let e of yt)ue.set(K(e),e);var $e=new Set("Dogr Dogra Gong Gunjala_Gondi Hanifi_Rohingya Maka Makasar Medefaidrin Medf Old_Sogdian Rohg Sogd Sogdian Sogo Extended_Pictographic Elym Elymaic Hmnp Nand Nandinagari Nyiakeng_Puachue_Hmong Wancho Wcho Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi EBase EComp EMod EPres ExtPict Cpmn Cypro_Minoan Old_Uyghur Ougr Tangsa Tnsa Toto Vith Vithkuqi Gara Garay Gukh Gurung_Khema Hrkt Katakana_Or_Hiragana Kawi Kirat_Rai Krai Nag_Mundari Nagm Ol_Onal Onao Sunu Sunuwar Todhri Todr Tulu_Tigalari Tutg Unknown Zzzz".split(" ")),Nt=new Map([[A(223),A(7838)],[A(107),A(8490)],[A(229),A(8491)],[A(969),A(8486)]]),$t=new Map([v(453),v(456),v(459),v(498),...ae(8072,8079),...ae(8088,8095),...ae(8104,8111),v(8124),v(8140),v(8188)]),X=new Map([["alnum",f`[\p{Alpha}\p{Nd}]`],["alpha",f`\p{Alpha}`],["ascii",f`\p{ASCII}`],["blank",f`[\p{Zs}\t]`],["cntrl",f`\p{cntrl}`],["digit",f`\p{Nd}`],["graph",f`[\P{space}&&\P{cntrl}&&\P{Cn}&&\P{Cs}]`],["lower",f`\p{Lower}`],["print",f`[[\P{space}&&\P{cntrl}&&\P{Cn}&&\P{Cs}]\p{Zs}]`],["punct",f`[\p{P}\p{S}]`],["space",f`\p{space}`],["upper",f`\p{Upper}`],["word",f`[\p{Alpha}\p{M}\p{Nd}\p{Pc}]`],["xdigit",f`\p{AHex}`]]),Ie=new Set(["alnum","blank","graph","print","word","xdigit"]);function It(e,t){let r=[];for(let s=e;s<=t;s++)r.push(s);return r}function K(e){return e.replace(/[- _]+/g,"").toLowerCase()}function v(e){let t=A(e);return[t.toLowerCase(),t]}function ae(e,t){return It(e,t).map(r=>v(r))}var le=new Set(["Lower","Lowercase","Upper","Uppercase","Ll","Lowercase_Letter","Lt","Titlecase_Letter","Lu","Uppercase_Letter"]);var g={Alternator:"Alternator",Assertion:"Assertion",Backreference:"Backreference",Character:"Character",CharacterClassClose:"CharacterClassClose",CharacterClassHyphen:"CharacterClassHyphen",CharacterClassIntersector:"CharacterClassIntersector",CharacterClassOpen:"CharacterClassOpen",CharacterSet:"CharacterSet",Directive:"Directive",GroupClose:"GroupClose",GroupOpen:"GroupOpen",Subroutine:"Subroutine",Quantifier:"Quantifier",VariableLengthCharacterSet:"VariableLengthCharacterSet",EscapedNumber:"EscapedNumber"},_={any:"any",digit:"digit",hex:"hex",posix:"posix",property:"property",space:"space",word:"word"},z={keep:"keep",flags:"flags"},k={atomic:"atomic",capturing:"capturing",group:"group",lookahead:"lookahead",lookbehind:"lookbehind"},Fe=new Map([["a",7],["b",8],["e",27],["f",12],["n",10],["r",13],["t",9],["v",11]]),Le="c.? | C(?:-.?)?",ve=f`[pP]\{(?:\^?[\x20\w]+\})?`,Re=f`u\{[^\}]*\}? | u\p{AHex}{0,4} | x\p{AHex}{0,2}`,De=f`\d{1,3}`,Ue=f`\[\^?\]?`,Me=/[?*+][?+]?|\{\d+(?:,\d*)?\}\??/,J=new RegExp(f`
  \\ (?:
    ${Le}
    | ${ve}
    | ${Re}
  ...
  | ${Ue}
  | .
`.replace(/\s+/g,""),"gsu"),pe=new RegExp(f`
  \\ (?:
    ${Le}
    | ${ve}
    | ${Re}
...
| &&
| .
`.replace(/\s+/g,""),"gsu");var bn=new RegExp(String.raw`
(?<groupN>\(\?<(?![=!])|\\[gk]<)
| (?<enclosedPU>\\[pPu]\{)
| (?<enclosedQ>\\q\{)
| (?<intervalQ>\{)
...
| --
| \\?.
`.replace(/\s+/g,""),"gsu");function it(e,t,r,s){return e.slice(0,t)+s+e.slice(t+r.length)}var ct=new RegExp(String.raw`(?<noncapturingStart>${ot})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,"gsu");function ut(e,t){if(!/\(\?>/.test(e))return e;let r="(?>",s=`(?:(?=(${t?.useEmulationGroups?at:""}`,n=[0],o=0,a=0,i=NaN,c;do{c=!1;let u=0,p=0,h=!1,C;for(ct.lastIndex=Number.isNaN(i)?0:i+s.length;C=ct.exec(e);){let{0:d,index:w,groups:{capturingStart:U,noncapturingStart:T}}=C;if(d==="[")u++;else if(u)d==="]"&&u--;else if(d===r&&!h)i=w,h=!0;else if(h&&T)p++;else if(U)h?p++:(o++,n.push(o+a));else if(d===")"&&h){if(!p){a++,e=`${e.slice(0,i)}${s}${e.slice(i+r.length,w)}))<$$${a+o}>)${e.slice(w+1)}`,c=!0;break}p--}}}while(c);return e=B(e,String.raw`\\(?<backrefNum>[1-9]\d*)|<\$\$(?<wrappedBackrefNum>\d+)>`,({0:u,groups:{backrefNum:p,wrappedBackrefNum:h}})=>{if(p){let C=+p;if(C>n.length-1)throw new Error(`Backref "${u}" greater than number of captures`);return`\\${n[C]}`}return`\\${h}`},x.DEFAULT),e}var lt=String.raw`(?:[?*+]|\{\d+(?:,\d*)?\})`,Ae=new RegExp(String.raw`
\\(?: \d+
  | c[A-Za-z]
  | [gk]<[^>]+>
  | [pPu]\{[^\}]+\}
...
| (?<qBase>${lt})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
| \\?.
`.replace(/\s+/g,""),"gsu");function pt(e){if(!new RegExp(`${lt}\\+`).test(e))return e;let t=[],r=null,s=null,n="",o=0,a;for(Ae.lastIndex=0;a=Ae.exec(e);){let{0:i,index:c,groups:{qBase:u,qMod:p,invalidQ:h}}=a;if(i==="[")o||(s=c),o++;else if(i==="]")o?o--:s=null;else if(!o)if(p==="+"&&n&&!n.startsWith("(")){if(h)throw new Error(`Invalid quantifier "${i}"`);let C=-1;if(/^\{\d+\}$/.test(u))e=it(e,c+u.length,p,"");else{if(n===")"||n==="]"){let d=n===")"?r:s;if(d===null)throw new Error(`Invalid unmatched "${n}"`);e=`${e.slice(0,d)}(?>${e.slice(d,c)}${u})${e.slice(c+i.length)}`}else e=`${e.slice(0,c-n.length)}(?>${n}${u})${e.slice(c+i.length)}`;C+=4}Ae.lastIndex+=C}else i[0]==="("?t.push(c):i===")"&&(r=t.length?t.pop():null);n=i}return e}var Ct=String.raw`\\g<(?<gRName>[^>&]+)&R=(?<gRDepth>\d+)>`,Se=String.raw`\(\?R=(?<rDepth>\d+)\)|${Ct}`,_e=String.raw`\(\?<(?![=!])(?<captureName>[^>]+)>`,re=new RegExp(String.raw`${_e}|${Se}|\\?.`,"gsu");function mt(e){if(!V(e,Se,x.DEFAULT))return e;if(V(e,String.raw`\\[1-9]`,x.DEFAULT))throw new Error("Numbered backrefs cannot be used with recursion; use named backref");if(V(e,String.raw`\(\?\(DEFINE\)`,x.DEFAULT))throw new Error("DEFINE groups cannot be used with recursion");let t=new Map,r=0,s;for(re.lastIndex=0;s=re.exec(e);){let{0:n,groups:{captureName:o,rDepth:a,gRName:i,gRDepth:c}}=s;if(n==="[")r++;else if(r)n==="]"&&r--;else if(o)t.set(o,re.lastIndex);else if(a){let u=+a;ft(u);let p=e.slice(0,s.index),h=e.slice(re.lastIndex);return gt(h),ht(p,h,u,!1)}else if(i){let u=+c;ft(u);let p=`Recursion via \\g<${i}&R=${c}> must be used within the referenced group`;if(!t.has(i))throw new Error(p);let h=t.get(i),C=nt(e,h);if(!V(C,Ct,x.DEFAULT))throw new Error(p);let d=e.slice(h,s.index),w=C.slice(d.length+n.length);return gt(w),e.slice(0,h)+ht(d,w,u,!0)+e.slice(h+C.length)}}throw new Error("Unexpected error; recursion was not processed")}function ft(e){if(e<2||e>100)throw new Error(`Max depth must be between 2 and 100; used ${e}`)}function gt(e){if(V(e,Se,x.DEFAULT))throw new Error("Recursion can only be used once per regex")}function ht(e,t,r,s){let n=new Set;s&&Ee(e+t,_e,({groups:{captureName:a}})=>{n.add(a)},x.DEFAULT);let o=r-1;return`${e}${dt(`(?:${e}`,o,s?n:null)}(?:)${dt(`${t})`,o,s?n:null,"backward")}${t}`}function dt(e,t,r,s="forward"){let o=i=>s==="backward"?t-i+2-1:i+2,a="";for(let i=0;i<t;i++){let c=o(i);a+=B(e,String.raw`${_e}|\\k<(?<backref>[^>]+)>`,({0:u,groups:{captureName:p,backref:h}})=>{if(h&&r&&!r.has(h))return u;let C=`_$${c}`;return p?`(?<${p}${C}>`:`\\k<${h}${C}>`},x.DEFAULT)}return a}function ke(e,t,r){let s=me(r),n=M(e,t),o=O(n,{optimize:s.optimize}),a=te(o,{allowBestEffort:s.allowBestEffort,bestEffortTarget:s.target}),i=et(a,s);return{pattern:ut(pt(mt(i.pattern))),flags:`${i.flags}${i.options.disable.v?"u":"v"}`}}function me(e){if(e?.target!==void 0&&!q[e.target])throw new Error(`Unexpected target "${e.target}"`);return{allowBestEffort:!0,maxRecursionDepth:6,optimize:!0,target:"ES2024",...e}}function Et(e,t){return O(M(e,t))}function Lr(e,t){return te(Et(e,t))}function vr(e,t="",r){let s=t.replace(/[^dg]+/g,"");t=t.replace(/[dg]+/g,"");let n=ke(e,t,r);return new RegExp(n.pattern,`${s}${n.flags}`)}return xt(Rr);})();
